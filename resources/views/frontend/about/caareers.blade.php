...
@section('main')
    <main>
        ...
        <div class="breadcrumb__area theme-bg pt-80 pb-80" data-background="assets/img/breadcrumb/breadcrumb-bg.png"
        ...
        <div class="job-about-area pt-80 pb-80">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="job-about-cicle-img text-center mb-60">
                        ...
                        <div class="section-title-wraper text-center wow tpfadeUp"
                            ...
                            <div class="tp-section">
                                <h2 class="tp-section__title mb-30">ideaCast IT is hiring</h2>
        ...
        <!--<div class="job-img-gallery pb-140">-->
        <!--    <div class="container">-->
        <!--        <div class="row justify-content-center">-->
        <!--            <div class="col-lg-6 wow tpfadeUp" style="visibility: hidden; animation-name: none;">-->
        <!--                <div class="job-img-1 mb-30 w-img" data-tilt="" data-tilt-perspective="2000">-->
        <!--                    <img src="assets/img/job/job-1.jpg" alt="ideacast it">-->
        <!--                </div>-->
        <!--            </div>-->
        <!--            <div class="col-lg-6 wow tpfadeUp" style="visibility: hidden; animation-name: none;">-->
        <!--                <div class="job-img-1 mb-30 w-img" data-tilt="" data-tilt-perspective="2000">-->
        <!--                    <img src="assets/img/job/job-2.jpg" alt="ideacast it">-->
        <!--                </div>-->
        <!--            </div>-->
        <!--            <div class="col-lg-8 col-12 wow tpfadeUp" style="visibility: hidden; animation-name: none;">-->
        <!--                <div class="job-lg-img-1 mb-30 w-img" data-tilt="" data-tilt-perspective="2000">-->
        <!--                    <img src="assets/img/job/job-3.jpg" alt="ideacast it">-->
        <!--                </div>-->
        <!--            </div>-->
        <!--        </div>-->
        ...
        <div class="tp-job-post-area theme-bg pb-40">
            <div class="container">
                <div class="row">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-6">
                                        <div class="tp-job-item__info">
                                            <span class="text-uppercase">posted:{{ \Carbon\Carbon::parse($data->date)->diffForHumans(); }}</span>
